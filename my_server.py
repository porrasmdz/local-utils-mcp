...
from services.trello import get_trello_board_lists, get_trello_cards_in_list, get_trello_card_by_id, get_trello_board_members \
    , get_trello_boards, get_trello_users, write_trello_card_in_list, update_trello_card, attach_file_to_trello_card
...
mcp = FastMCP( "Local Windows Utils",
               ...
               tools=[
                   ...
                   get_trello_boards, get_trello_users, write_trello_card_in_list, update_trello_card,
